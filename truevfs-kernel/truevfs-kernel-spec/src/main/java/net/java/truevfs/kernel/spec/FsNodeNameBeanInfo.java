...
public final class FsNodeNameBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    private static BeanDescriptor beanDescriptor = new BeanDescriptor  ( net.java.truevfs.kernel.spec.FsNodeName.class , null ); // NOI18N
    ...
    static {//GEN-HEADEREND:BeanDescriptor
        ...
        final PersistenceDelegate pd = new PersistenceDelegate() {
            ...
            protected Expression instantiate(Object oldInstance, Encoder out) {
                final FsNodeName name = (FsNodeName) oldInstance;
                return new Expression(
                    name,
                    name.getClass(),
                    "new", // NOI18N
                    new Object[] { name.toUri() });
            }
        };
