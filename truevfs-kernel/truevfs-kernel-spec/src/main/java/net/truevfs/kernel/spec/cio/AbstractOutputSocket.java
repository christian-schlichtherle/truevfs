...
import net.truevfs.kernel.spec.io.ChannelOutputStream;
 ...
 */
@Immutable
public abstract class AbstractOutputSocket<T extends Entry>
extends AbstractIoSocket<T> implements OutputSocket<T> {
