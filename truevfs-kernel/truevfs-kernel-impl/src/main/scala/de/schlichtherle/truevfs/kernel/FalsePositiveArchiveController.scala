...
/** Implements a chain of responsibility for resolving
  * [[de.schlichtherle.truevfs.kernel.FalsePositiveArchiveException]]s which
  * may get thrown by its decorated file system controller.
  * 
  * This controller is a barrier for
  * [[de.schlichtherle.truevfs.kernel.FalsePositiveArchiveException]]s:
  ...
  *    [[de.schlichtherle.truevfs.kernel.ControlFlowException]]s work as
  *    designed.
  * 
