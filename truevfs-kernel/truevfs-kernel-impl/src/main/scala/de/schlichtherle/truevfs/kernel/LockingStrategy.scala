...
private abstract class LockingStrategy {
  ...
  /** Holds the given lock while calling the given operation.
    ...
    * [[de.schlichtherle.truevfs.kernel.NeedsLockRetryException]], then
    ...
    * [[de.schlichtherle.truevfs.kernel.NeedsLockRetryException]] gets
    * thrown.
    ...
    * state, because a
    * [[de.schlichtherle.truevfs.kernel.NeedsLockRetryException]] may occur
    * anytime!
    * 
