...
/** Manages I/O to the entry which represents the target archive file in its
  ...
  * when
  * [[de.schlichtherle.truevfs.kernel.FalsePositiveArchiveException detecting a false positive archive file], or
  * [[de.schlichtherle.truevfs.kernel.NeedsSyncException requiring a sync].
  *
