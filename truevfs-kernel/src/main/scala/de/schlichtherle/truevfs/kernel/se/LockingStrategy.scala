...
private abstract class LockingStrategy {
  ...
  /** Holds the given lock while calling the given operation.
    ...
    * [[de.schlichtherle.truevfs.kernel.se.NeedsLockRetryException]], then
    ...
    * [[de.schlichtherle.truevfs.kernel.se.NeedsLockRetryException]] gets
    * thrown.
    ...
    * state, because a
    * [[de.schlichtherle.truevfs.kernel.se.NeedsLockRetryException]] may occur
    * anytime!
    * 
