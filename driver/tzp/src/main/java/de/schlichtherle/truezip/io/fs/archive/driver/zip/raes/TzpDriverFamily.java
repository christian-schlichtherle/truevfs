...
public final class TzpDriverFamily implements FsDriverProvider {
    ...
    public TzpDriverFamily() {
        ...
        drivers.put(FsScheme.create("tzp"), new SafeZipRaesDriver());
        drivers.put(FsScheme.create("zip.rae"), new SafeZipRaesDriver());
        drivers.put(FsScheme.create("zip.raes"), new SafeZipRaesDriver());
