...
import static net.java.truevfs.component.zip.Constants.*;
import static net.java.truevfs.component.zip.ExtraField.WINZIP_AES_ID;
import static net.java.truevfs.component.zip.WinZipAesEntryExtraField.VV_AE_1;
import static net.java.truevfs.component.zip.WinZipAesEntryExtraField.VV_AE_2;
import static net.java.truevfs.component.zip.WinZipAesUtils.overhead;
import static net.java.truevfs.component.zip.ZipEntry.*;
import static net.java.truevfs.component.zip.ZipParametersUtils.parameters;
