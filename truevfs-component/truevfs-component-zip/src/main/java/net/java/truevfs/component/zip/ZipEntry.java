...
import static net.java.truevfs.component.zip.Constants.EMPTY;
import static net.java.truevfs.component.zip.Constants.FORCE_ZIP64_EXT;
import static net.java.truevfs.component.zip.ExtraField.WINZIP_AES_ID;
import static net.java.truevfs.component.zip.ExtraField.ZIP64_HEADER_ID;
import static net.java.truevfs.component.zip.LittleEndian.readLong;
import static net.java.truevfs.component.zip.LittleEndian.writeLong;
