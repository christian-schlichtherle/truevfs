...
import static net.truevfs.component.zip.Constants.*;
import static net.truevfs.component.zip.ExtraField.WINZIP_AES_ID;
import static net.truevfs.component.zip.WinZipAesEntryExtraField.VV_AE_1;
import static net.truevfs.component.zip.WinZipAesEntryExtraField.VV_AE_2;
