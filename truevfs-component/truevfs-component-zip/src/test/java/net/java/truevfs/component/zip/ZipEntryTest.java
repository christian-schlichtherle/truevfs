...
import net.java.truevfs.component.zip.UInt;
import net.java.truevfs.component.zip.ZipEntry;
import net.java.truevfs.component.zip.UByte;
import net.java.truevfs.component.zip.ULong;
import net.java.truevfs.component.zip.UShort;
