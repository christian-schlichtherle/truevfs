...
import static net.java.truevfs.component.zip.DateTimeConverter.MAX_DOS_TIME;
import static net.java.truevfs.component.zip.DateTimeConverter.MIN_DOS_TIME;
