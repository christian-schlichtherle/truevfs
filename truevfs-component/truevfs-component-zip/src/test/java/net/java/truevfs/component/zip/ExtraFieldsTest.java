...
import net.java.truevfs.component.zip.ExtraField;
import net.java.truevfs.component.zip.DefaultExtraField;
import net.java.truevfs.component.zip.ExtraFields;
