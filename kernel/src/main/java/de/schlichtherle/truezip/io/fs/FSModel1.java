 ...
 */
@ThreadSafe
public class FSModel1 {

    private final FSMountPoint1 mountPoint;
    private final FSModel1 parent;
    private volatile boolean touched;
    private Set<FsTouchedListener> touchedListeners
            = new LinkedHashSet<FsTouchedListener>();

    public FSModel1( FSMountPoint1 mountPoint) {
        this(mountPoint, null);
    }

    public FSModel1( @NonNull final FSMountPoint1 mountPoint,
                            @CheckForNull final FSModel1 parent) {
     ...
     */
    @NonNull
    public final FSMountPoint1 getMountPoint() {
        return mountPoint;
    }
     ...
     */
    @Nullable
    public final FSModel1 getParent() {
        return parent;
    }
    ...
    public final void setTouched(final boolean newTouched) {
        ...
        if (newTouched != oldTouched) {
            final FSEvent1 event = new FSEvent1(this);
    ...
    public final boolean equals(@CheckForNull Object that) {
        return this == that
                || that instanceof FSModel1
                    && this.mountPoint.equals(((FSModel1) that).mountPoint);
    }
