 ...
 * @version $Id$
 */
public class FSPathBeanInfo1 extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    private static BeanDescriptor beanDescriptor = new BeanDescriptor  ( de.schlichtherle.truezip.io.fs.FSPath1.class , null ); // NOI18N
    ...
    static {//GEN-HEADEREND:BeanDescriptor
        ...
        final PersistenceDelegate pd = new PersistenceDelegate() {
            ...
            protected Expression instantiate(Object oldInstance, Encoder out) {
                final FSPath1 path = (FSPath1) oldInstance;
