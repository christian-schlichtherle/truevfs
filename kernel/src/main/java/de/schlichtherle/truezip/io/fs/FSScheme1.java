 ...
 */
@Immutable
public final class FSScheme1 implements Serializable, Comparable<FSScheme1> {
     ...
     * {@link #FSScheme1(String) new FSScheme1(scheme)}
     ...
     * @return A new scheme.
     */
    public static @NonNull FSScheme1 create(String scheme) {
        try {
            return new FSScheme1(scheme);
     ...
     */
    public FSScheme1(final @NonNull String scheme) throws URISyntaxException {
        int i = scheme.length();
        if (0 >= i) {
    ...
    public boolean equals(Object that) {
        return this == that
                || that instanceof FSScheme1
                    && this.scheme.equalsIgnoreCase(((FSScheme1) that).scheme);
    }

    @Override
    public int compareTo(FSScheme1 that) {
