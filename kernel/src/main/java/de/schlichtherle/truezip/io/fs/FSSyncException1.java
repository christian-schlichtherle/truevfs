 ...
 * @version $Id$
 */
public class FSSyncException1 extends ChainableIOException {
     ...
     */
    public FSSyncException1(String message) {
        super(message);
    }

    public FSSyncException1(FSModel1 model, IOException cause) {
        super(model.getMountPoint().toString(), cause);
    }

    FSSyncException1(FSModel1 model, IOException cause, int priority) {
