...
import static de.schlichtherle.truezip.io.fs.FSPath1.MOUNT_POINT_SEPARATOR;
 ...
 *     parsed according the syntax constraints for a {@link FSPath1} and the
...
public final class FSMountPoint1 implements Serializable, Comparable<FSMountPoint1> {

    private static final long serialVersionUID = 5723957985634276648L;

    private @NonNull URI uri; // not final for serialization only!

    private transient @Nullable FSPath1 path;

    private transient volatile @Nullable FSScheme1 scheme;

    private transient volatile @Nullable FSMountPoint1 hierarchical;

    /**
     * Equivalent to {@link #create(URI, boolean) create(uri, false)}.
     */
    public static @NonNull FSMountPoint1
     ...
     * {@link #FSMountPoint1(String, boolean) new FSMountPoint1(uri, normalize)}
    ...
    create(@NonNull String uri, @NonNull FsUriModifier modifier) {
        try {
            return new FSMountPoint1(uri, modifier);
     ...
     * This static factory method calls
     * {@link #FSMountPoint1(URI, boolean) new FSMountPoint1(uri, normalize)}
     * and wraps any thrown {@link URISyntaxException} in an
     * {@link IllegalArgumentException}.
     *
     ...
     * scheme and path.
     * This static factory method calls
     * {@link #FSMountPoint1(FSScheme1, FSPath1) new FSMountPoint1(scheme, path)}
     * and wraps any thrown {@link URISyntaxException} in an
     * {@link IllegalArgumentException}.
     *
     ...
     */
    public static @NonNull FSMountPoint1
    create(@NonNull FSScheme1 scheme, @NonNull FSPath1 path) {
        try {
            return new FSMountPoint1(scheme, path);
        } catch (URISyntaxException ex) {
            throw new IllegalArgumentException(ex);
        }
    }
    ...
    /**
     * Equivalent to {@link #FSMountPoint1(String, boolean) new FSMountPoint1(uri, false)}.
     */
    public FSMountPoint1(@NonNull String uri) throws URISyntaxException {
     ...
     *         syntax constraints for mount points.
     */
    public FSMountPoint1(@NonNull String uri, @NonNull FsUriModifier modifier)
    throws URISyntaxException {
        parse(uri, modifier);
    }

    /**
     * Equivalent to {@link #FSMountPoint1(URI, boolean) new FSMountPoint1(uri, false)}.
     */
    public FSMountPoint1(@NonNull URI uri) throws URISyntaxException {
        parse(uri, FsUriModifier.NONE);
    }
     ...
     *         syntax constraints for mount points.
     */
    public FSMountPoint1(@NonNull URI uri, @NonNull FsUriModifier modifier)
    throws URISyntaxException {
        parse(uri, modifier);
    }
     ...
     *         would not conform to the syntax constraints for mount points.
     */
    public FSMountPoint1(final @NonNull FSScheme1 scheme,
                        final @NonNull FSPath1 path)
    throws URISyntaxException {
    ...
    throws URISyntaxException {
        ...
        if (uri.isOpaque()) {
            ...
            path = new FSPath1(ssp.substring(0, i), modifier);
            final URI pathUri = path.getUri();
            if (!pathUri.isAbsolute())
     ...
     */
    public @NonNull FSScheme1 getScheme() {
        return null != scheme ? scheme : (scheme = FSScheme1.create(uri.getScheme()));
    }
     ...
     */
    public @Nullable FSPath1 getPath() {
        return path;
    }
     ...
     */
    public @Nullable FSMountPoint1 getParent() {
    ...
    resolve(@NonNull FSEntryName1 entryName) {
        return new FSPath1(this, entryName);
    }
     ...
     *         this mount point so that it's absolute and hierarchical.
     */
    public @NonNull FSMountPoint1 hierarchicalize() {
        if (null != hierarchical)
            return hierarchical;
        if (uri.isOpaque()) {
            final URI uri = path.hierarchicalize().getUri();
            try {
                return hierarchical = new FSMountPoint1(new URI(
    ...
    public boolean equals(@CheckForNull Object that) {
        return this == that
                || that instanceof FSMountPoint1
                    && this.uri.equals(((FSMountPoint1) that).uri);
    }
     ...
     */
    @Override
    public int compareTo(@NonNull FSMountPoint1 that) {
