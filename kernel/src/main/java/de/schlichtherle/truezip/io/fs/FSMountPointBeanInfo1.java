 ...
 * @version $Id$
 */
public class FSMountPointBeanInfo1 extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    private static BeanDescriptor beanDescriptor = new BeanDescriptor  ( de.schlichtherle.truezip.io.fs.FSMountPoint1.class , null ); // NOI18N
    ...
    static {//GEN-HEADEREND:BeanDescriptor
        ...
        final PersistenceDelegate pd = new PersistenceDelegate() {
            ...
            protected Expression instantiate(Object oldInstance, Encoder out) {
                final FSMountPoint1 mountPoint = (FSMountPoint1) oldInstance;
