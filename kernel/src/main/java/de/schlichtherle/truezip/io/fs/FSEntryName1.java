...
import static de.schlichtherle.truezip.io.fs.FSEntryName1.SEPARATOR;
 ...
 */
@Immutable
public final class FSEntryName1 extends EntryName {
     ...
     */
    public static final FSEntryName1 ROOT
            = FSEntryName1.create(URI.create(""));

    /**
     * Equivalent to {@link #create(String, boolean) create(uri, false)}.
     */
    public static @NonNull FSEntryName1
     ...
     * {@link #FSEntryName1(String, boolean) new FSEntryName1(uri, normalize)}
    ...
    create(@NonNull String uri, @NonNull FsUriModifier modifier) {
        try {
            return new FSEntryName1(uri, modifier);
     ...
     * This static factory method calls
     * {@link #FSEntryName1(URI, boolean) new FSEntryName1(new URI(null, null, path, query, null), normalize)}
     * and wraps any thrown {@link URISyntaxException} in an
     * {@link IllegalArgumentException}.
     *
    ...
    create(@NonNull String path, @CheckForNull String query, @NonNull FsUriModifier modifier) {
        try {
            return new FSEntryName1(new URI(null, null, path, query, null), modifier);
        } catch (URISyntaxException ex) {
            throw new IllegalArgumentException(ex);
        }
    }
     ...
     * This static factory method calls
     * {@link #FSEntryName1(URI, boolean) new FSEntryName1(uri, normalize)}
     * and wraps any thrown {@link URISyntaxException} in an
     * {@link IllegalArgumentException}.
     *
    ...
    /**
     * Equivalent to {@link #FSEntryName1(String, boolean) new FSEntryName1(uri, false)}.
     */
    public FSEntryName1(@NonNull String uri) throws URISyntaxException {
     ...
     *         syntax constraints for entry names.
     */
    public FSEntryName1(@NonNull String uri, @NonNull FsUriModifier modifier)
    throws URISyntaxException {
        this(new URI(uri), modifier);
    }

    /**
     * Equivalent to {@link #FSEntryName1(URI, boolean) new FSEntryName1(uri, false)}.
     */
    public FSEntryName1(@NonNull URI uri) throws URISyntaxException {
        this(uri, FsUriModifier.NONE);
    }
     ...
     */
    public FSEntryName1(@NonNull URI uri, final @NonNull FsUriModifier modifier)
    throws URISyntaxException {
     ...
     * {@link FSEntryName1#SEPARATOR}, so calling this constructor with
     ...
     */
    FSEntryName1(final @NonNull FSEntryName1 parent,
                final @NonNull FSEntryName1 member) {
        super(parent, member);
