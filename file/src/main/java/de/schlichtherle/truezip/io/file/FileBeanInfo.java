 ...
 * @author christian
 */
public class FileBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    private static BeanDescriptor beanDescriptor = new BeanDescriptor  ( de.schlichtherle.truezip.io.file.File.class , null ); // NOI18N
    ...
    static {//GEN-HEADEREND:BeanDescriptor
        ...
        final PersistenceDelegate pd = new PersistenceDelegate() {
            ...
            protected Expression instantiate(Object oldInstance, Encoder out) {
                final File file = (File) oldInstance;
