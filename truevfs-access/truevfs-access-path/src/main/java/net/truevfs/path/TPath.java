...
import static net.truevfs.path.TPathScanner.*;
import java.io.File;
...
<dl>
    ...
    <dt>Absolute path name with plain {@link net.truevfs.file.TFile}:</dt>
...
<dl>
    ...
    <dt>Absolute path name with {@link net.truevfs.file.TFile}:</dt>
