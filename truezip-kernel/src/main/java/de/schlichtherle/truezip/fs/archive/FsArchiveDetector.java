...
public final class FsArchiveDetector
implements FsCompositeDriver, FsDriverProvider {
     ...
     */
    public static final FsArchiveDetector
            NULL = new FsArchiveDetector("");
     ...
     */
    public static final FsArchiveDetector
            ALL = new FsArchiveDetector(null);
     ...
     */
    public FsArchiveDetector(@CheckForNull String suffixes) {
     ...
     */
    public FsArchiveDetector(final FsDriverProvider provider,
     ...
     */
    public FsArchiveDetector(String suffixes, @CheckForNull FsDriver driver) {
     ...
     */
    public FsArchiveDetector(FsDriverProvider delegate,
                            String suffixes,
     ...
     * @see    SuffixSet Syntax contraints for suffix lists.
     */
    public FsArchiveDetector(FsDriverProvider delegate, Object[][] config) {
