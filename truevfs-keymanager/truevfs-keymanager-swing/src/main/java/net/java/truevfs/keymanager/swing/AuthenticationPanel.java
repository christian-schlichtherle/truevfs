...
import net.java.truevfs.keymanager.swing.io.FileComboBoxBrowser;
...
public final class AuthenticationPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        final net.java.truevfs.keymanager.swing.util.EnhancedPanel keyFilePanel = new net.java.truevfs.keymanager.swing.util.EnhancedPanel();
        ...
        keyFilePanel.addPanelListener(new net.java.truevfs.keymanager.swing.util.PanelListener() {
    ...
    private void keyFilePanelAncestorWindowShown(net.java.truevfs.keymanager.swing.util.PanelEvent evt) {//GEN-FIRST:event_keyFilePanelAncestorWindowShown
