...
final class WriteKeyPanel extends KeyPanel {
    ...
    private void initComponents() {
        ...
        final net.java.truevfs.keymanager.swing.util.EnhancedPanel passwdPanel = new net.java.truevfs.keymanager.swing.util.EnhancedPanel();
        ...
        passwdPanel.addPanelListener(new net.java.truevfs.keymanager.swing.util.PanelListener() {
            public void ancestorWindowShown(net.java.truevfs.keymanager.swing.util.PanelEvent evt) {
                passwdPanelAncestorWindowShown(evt);
            }
            public void ancestorWindowHidden(net.java.truevfs.keymanager.swing.util.PanelEvent evt) {
            }
        });
    ...
    private void passwdPanelAncestorWindowShown(net.java.truevfs.keymanager.swing.util.PanelEvent evt) {//GEN-FIRST:event_passwdPanelAncestorWindowShown
    ...
    private final net.java.truevfs.keymanager.swing.AuthenticationPanel authenticationPanel = new net.java.truevfs.keymanager.swing.AuthenticationPanel();
