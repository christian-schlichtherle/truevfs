...
final class WriteKeyPanel extends KeyPanel {
    ...
    private void initComponents() {
        ...
        final net.truevfs.keymanager.swing.util.EnhancedPanel passwdPanel = new net.truevfs.keymanager.swing.util.EnhancedPanel();
        ...
        passwdPanel.addPanelListener(new net.truevfs.keymanager.swing.util.PanelListener() {
            public void ancestorWindowShown(net.truevfs.keymanager.swing.util.PanelEvent evt) {
                passwdPanelAncestorWindowShown(evt);
            }
            public void ancestorWindowHidden(net.truevfs.keymanager.swing.util.PanelEvent evt) {
            }
        });
    ...
    private void passwdPanelAncestorWindowShown(net.truevfs.keymanager.swing.util.PanelEvent evt) {//GEN-FIRST:event_passwdPanelAncestorWindowShown
    ...
    private final net.truevfs.keymanager.swing.AuthenticationPanel authenticationPanel = new net.truevfs.keymanager.swing.AuthenticationPanel();
