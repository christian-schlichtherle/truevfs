...
public final class AuthenticationPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        final net.truevfs.keymanager.swing.util.EnhancedPanel keyFilePanel = new net.truevfs.keymanager.swing.util.EnhancedPanel();
        ...
        keyFilePanel.addPanelListener(new net.truevfs.keymanager.swing.util.PanelListener() {
    ...
    private void keyFilePanelAncestorWindowShown(net.truevfs.keymanager.swing.util.PanelEvent evt) {//GEN-FIRST:event_keyFilePanelAncestorWindowShown
