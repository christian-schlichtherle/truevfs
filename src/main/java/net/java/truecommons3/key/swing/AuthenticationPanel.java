...
import net.java.truecommons3.key.swing.io.FileComboBoxBrowser;
...
public final class AuthenticationPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        final net.java.truecommons3.key.swing.util.EnhancedPanel keyFilePanel = new net.java.truecommons3.key.swing.util.EnhancedPanel();
        ...
        keyFilePanel.addPanelListener(new net.java.truecommons3.key.swing.util.PanelListener() {
    ...
    private void keyFilePanelAncestorWindowShown(net.java.truecommons3.key.swing.util.PanelEvent evt) {//GEN-FIRST:event_keyFilePanelAncestorWindowShown
