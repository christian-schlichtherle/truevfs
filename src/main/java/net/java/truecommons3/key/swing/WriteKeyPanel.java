...
final class WriteKeyPanel extends KeyPanel {
    ...
    private void initComponents() {
        ...
        final net.java.truecommons3.key.swing.util.EnhancedPanel passwdPanel = new net.java.truecommons3.key.swing.util.EnhancedPanel();
        ...
        passwdPanel.addPanelListener(new net.java.truecommons3.key.swing.util.PanelListener() {
            public void ancestorWindowShown(net.java.truecommons3.key.swing.util.PanelEvent evt) {
                passwdPanelAncestorWindowShown(evt);
            }
            public void ancestorWindowHidden(net.java.truecommons3.key.swing.util.PanelEvent evt) {
            }
        });
    ...
    private void passwdPanelAncestorWindowShown(net.java.truecommons3.key.swing.util.PanelEvent evt) {//GEN-FIRST:event_passwdPanelAncestorWindowShown
    ...
    private final net.java.truecommons3.key.swing.AuthenticationPanel authenticationPanel = new net.java.truecommons3.key.swing.AuthenticationPanel();
