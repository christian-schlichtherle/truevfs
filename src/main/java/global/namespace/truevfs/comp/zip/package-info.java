 ...
 * <li>Support for
 *     {@link global.namespace.truevfs.comp.zip.ZipOutputStream#ZipOutputStream(java.io.OutputStream, global.namespace.truevfs.comp.zip.ZipFile) appending}
 *     to existing ZIP files.
 * <li>Support for
 *     {@link global.namespace.truevfs.comp.zip.ZipFile#recoverLostEntries() recovering}
 *     lost entries when reading a ZIP file.
 * <li>Support for
 *     {@link global.namespace.truevfs.comp.zip.ZipEntry#isEncrypted() reading}
 *     and
 *     {@link global.namespace.truevfs.comp.zip.ZipEntry#setEncrypted(boolean) writing}
 ...
 *     {@link global.namespace.truevfs.comp.zip.WinZipAesParameters}
 *     and inject it for reading and writing to the
 *     {@link global.namespace.truevfs.comp.zip.ZipFile#setCryptoParameters(global.namespace.truevfs.comp.zip.ZipCryptoParameters) ZipFile.setCryptoParameters(ZipCryptoParameters)}
 *     and
 *     {@link global.namespace.truevfs.comp.zip.ZipOutputStream#setCryptoParameters(global.namespace.truevfs.comp.zip.ZipCryptoParameters) ZipOutputStream.setCryptoParameters(ZipCryptoParameters)}
 *     classes.
 * <li>Support for
 *     {@link global.namespace.truevfs.comp.zip.ZipEntry#getMethod() reading}
 *     and
 *     {@link global.namespace.truevfs.comp.zip.ZipEntry#setMethod(int) writing}
 ...
 *     different locales!
 * <li>Support for
 *     {@link global.namespace.truevfs.comp.zip.ZipEntry#getExternalAttributes() reading}
 *     and
 *     {@link global.namespace.truevfs.comp.zip.ZipEntry#setExternalAttributes(long) writing}
 ...
 *         executable code.
 *     </ol>
 * <li>{@link global.namespace.truevfs.comp.zip.ZipFile} supports reading archive
