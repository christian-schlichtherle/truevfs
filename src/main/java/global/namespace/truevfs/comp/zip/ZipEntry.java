...
import static global.namespace.truevfs.comp.zip.Constants.EMPTY;
import static global.namespace.truevfs.comp.zip.Constants.FORCE_ZIP64_EXT;
import static global.namespace.truevfs.comp.zip.ExtraField.WINZIP_AES_ID;
import static global.namespace.truevfs.comp.zip.ExtraField.ZIP64_HEADER_ID;
import static global.namespace.truevfs.comp.zip.LittleEndian.readLong;
import static global.namespace.truevfs.comp.zip.LittleEndian.writeLong;
...
public class ZipEntry implements Cloneable {
     ...
     *         ({@value global.namespace.truevfs.comp.zip.ULong#MAX_VALUE}).
