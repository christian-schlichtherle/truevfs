...
import static global.namespace.truevfs.comp.key.macos.keychain.Keychain.AttributeClass.*;
 ...
 * The methods in this class generally throw {@link KeychainException} to report any errors when accessing this
 * keychain.
 * <p>
...
public abstract class Keychain implements AutoCloseable {
     ...
     *                 If empty then the user gets prompted for a password.
     */
    public static Keychain open(String path, Supplier<char[]> password) throws KeychainException {
    ...
    public interface Item {
         ...
         */
        void setAttribute(AttributeClass id, @Nullable ByteBuffer value) throws KeychainException;
         ...
         */
        void putAttributeMap(Map<AttributeClass, ByteBuffer> attributes) throws KeychainException;
    ...
    /**
     * Enumerates classes of attributes of items in a keychain.
     */
    public enum AttributeClass {
        ...
        static Optional<AttributeClass> lookup(int tag) {
            return Optional.ofNullable(lookupNullable(tag));
        }

        private static @Nullable AttributeClass lookupNullable(final int tag) {
            switch (tag) {
