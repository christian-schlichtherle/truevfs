...
public class KeyManagerZipCryptoParameters
    ...
    private class WinZipAes implements WinZipAesParameters {
        ...
        @Override
        public AesKeyStrength getKeyStrength(final String name) throws ZipKeyException {
            final KeyProvider<AesPbeParameters>
                    provider = manager.provider(resourceUri(name));
            try {
        ...
        @Override
        public void setKeyStrength(final String name, final AesKeyStrength keyStrength) throws ZipKeyException {
            final KeyProvider<AesPbeParameters> provider = manager.provider(resourceUri(name));
