 ...
 *
 * @deprecated This class solely exists to support
 *             {@link XMLEncoder}/{@link XMLDecoder} and is not intended for
 *             public use.
 * @author     Christian Schlichtherle
 */
@Deprecated
@Nullable
public final class TFileBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    private static BeanDescriptor beanDescriptor = new BeanDescriptor  ( global.namespace.truevfs.access.TFile.class , null ); // NOI18N
    ...
    static {//GEN-HEADEREND:BeanDescriptor
        ...
        final PersistenceDelegate pd = new PersistenceDelegate() {
            ...
            protected Expression instantiate(Object oldInstance, Encoder out) {
                final TFile file = (TFile) oldInstance;
