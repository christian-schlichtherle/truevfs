...
import global.namespace.truevfs.commons.key.api.prompting.PromptingPbeParameters;
...
final class WriteKeyPanel extends KeyPanel {
    ...
    private void initComponents() {
        ...
        final global.namespace.truevfs.commons.key.swing.util.EnhancedPanel passwdPanel = new global.namespace.truevfs.commons.key.swing.util.EnhancedPanel();
        ...
        passwdPanel.addPanelListener(new global.namespace.truevfs.commons.key.swing.util.PanelListener() {
            public void ancestorWindowShown(global.namespace.truevfs.commons.key.swing.util.PanelEvent evt) {
                passwdPanelAncestorWindowShown(evt);
            }
            public void ancestorWindowHidden(global.namespace.truevfs.commons.key.swing.util.PanelEvent evt) {
            }
        });
    ...
    private void passwdPanelAncestorWindowShown(global.namespace.truevfs.commons.key.swing.util.PanelEvent evt) {//GEN-FIRST:event_passwdPanelAncestorWindowShown
    ...
    private final global.namespace.truevfs.commons.key.swing.AuthenticationPanel authenticationPanel = new global.namespace.truevfs.commons.key.swing.AuthenticationPanel();
