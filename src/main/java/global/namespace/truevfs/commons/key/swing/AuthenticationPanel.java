...
import global.namespace.truevfs.commons.key.swing.io.FileComboBoxBrowser;
...
public final class AuthenticationPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        final global.namespace.truevfs.commons.key.swing.util.EnhancedPanel keyFilePanel = new global.namespace.truevfs.commons.key.swing.util.EnhancedPanel();
        ...
        keyFilePanel.addPanelListener(new global.namespace.truevfs.commons.key.swing.util.PanelListener() {
    ...
    private void keyFilePanelAncestorWindowShown(global.namespace.truevfs.commons.key.swing.util.PanelEvent evt) {//GEN-FIRST:event_keyFilePanelAncestorWindowShown
