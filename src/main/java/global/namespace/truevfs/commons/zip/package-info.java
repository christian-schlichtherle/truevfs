 ...
 * <li>Support for
 *     {@link global.namespace.truevfs.commons.zip.ZipOutputStream#ZipOutputStream(java.io.OutputStream, global.namespace.truevfs.commons.zip.ZipFile) appending}
 *     to existing ZIP files.
 * <li>Support for
 *     {@link global.namespace.truevfs.commons.zip.ZipFile#recoverLostEntries() recovering}
 *     lost entries when reading a ZIP file.
 * <li>Support for
 *     {@link global.namespace.truevfs.commons.zip.ZipEntry#isEncrypted() reading}
 *     and
 *     {@link global.namespace.truevfs.commons.zip.ZipEntry#setEncrypted(boolean) writing}
 ...
 *     {@link global.namespace.truevfs.commons.zip.WinZipAesParameters}
 *     and inject it for reading and writing to the
 *     {@link global.namespace.truevfs.commons.zip.ZipFile#setCryptoParameters(global.namespace.truevfs.commons.zip.ZipCryptoParameters) ZipFile.setCryptoParameters(ZipCryptoParameters)}
 *     and
 *     {@link global.namespace.truevfs.commons.zip.ZipOutputStream#setCryptoParameters(global.namespace.truevfs.commons.zip.ZipCryptoParameters) ZipOutputStream.setCryptoParameters(ZipCryptoParameters)}
 *     classes.
 * <li>Support for
 *     {@link global.namespace.truevfs.commons.zip.ZipEntry#getMethod() reading}
 *     and
 *     {@link global.namespace.truevfs.commons.zip.ZipEntry#setMethod(int) writing}
 ...
 *     different locales!
 * <li>Support for
 *     {@link global.namespace.truevfs.commons.zip.ZipEntry#getExternalAttributes() reading}
 *     and
 *     {@link global.namespace.truevfs.commons.zip.ZipEntry#setExternalAttributes(long) writing}
 ...
 *         executable code.
 *     </ol>
 * <li>{@link global.namespace.truevfs.commons.zip.ZipFile} supports reading archive
