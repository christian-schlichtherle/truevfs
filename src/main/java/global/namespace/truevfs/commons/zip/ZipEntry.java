...
import static global.namespace.truevfs.commons.zip.Constants.FORCE_ZIP64_EXT;
import static global.namespace.truevfs.commons.zip.ExtraField.WINZIP_AES_ID;
import static global.namespace.truevfs.commons.zip.ExtraField.ZIP64_HEADER_ID;
import static global.namespace.truevfs.commons.zip.LittleEndian.readLong;
import static global.namespace.truevfs.commons.zip.LittleEndian.writeLong;
 ...
 */
// TODO: Consider implementing global.namespace.truevfs.kernel.entry.Entry.
public class ZipEntry implements Cloneable {
     ...
     *         ({@value global.namespace.truevfs.commons.zip.ULong#MAX_VALUE}).
