 ...
 * <p>
 * All methods of this interface must reflect all entries, including those which have just been partially written yet,
 * i.e. which have not already received a call to their {@code close()} method.
 *
 * @param   <E> the type of the entries in this container.
 * @see     InputContainer
 * @author  Christian Schlichtherle
 */
public interface OutputContainer<E extends Entry> extends Closeable, Container<E> {

    /**
     * Returns an output socket for writing to the given entry.
     *
     * @param  entry the entry, which must be the
     *         {@linkplain OutputSocket#getTarget local target} of the
