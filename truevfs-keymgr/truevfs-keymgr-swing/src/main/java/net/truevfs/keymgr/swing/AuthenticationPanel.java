...
public final class AuthenticationPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        final net.truevfs.keymgr.swing.util.EnhancedPanel keyFilePanel = new net.truevfs.keymgr.swing.util.EnhancedPanel();
        ...
        keyFilePanel.addPanelListener(new net.truevfs.keymgr.swing.util.PanelListener() {
    ...
    private void keyFilePanelAncestorWindowShown(net.truevfs.keymgr.swing.util.PanelEvent evt) {//GEN-FIRST:event_keyFilePanelAncestorWindowShown
