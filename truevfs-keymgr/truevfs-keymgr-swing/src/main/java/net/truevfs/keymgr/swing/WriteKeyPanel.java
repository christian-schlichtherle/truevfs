...
final class WriteKeyPanel extends KeyPanel {
    ...
    private void initComponents() {
        ...
        final net.truevfs.keymgr.swing.util.EnhancedPanel passwdPanel = new net.truevfs.keymgr.swing.util.EnhancedPanel();
        ...
        passwdPanel.addPanelListener(new net.truevfs.keymgr.swing.util.PanelListener() {
            public void ancestorWindowShown(net.truevfs.keymgr.swing.util.PanelEvent evt) {
                passwdPanelAncestorWindowShown(evt);
            }
            public void ancestorWindowHidden(net.truevfs.keymgr.swing.util.PanelEvent evt) {
            }
        });
    ...
    private void passwdPanelAncestorWindowShown(net.truevfs.keymgr.swing.util.PanelEvent evt) {//GEN-FIRST:event_passwdPanelAncestorWindowShown
    ...
    private final net.truevfs.keymgr.swing.AuthenticationPanel authenticationPanel = new net.truevfs.keymgr.swing.AuthenticationPanel();
