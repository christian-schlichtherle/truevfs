 ...
 * files as if they were just plain directories by means of the
 * {@link net.truevfs.path.TPath} class et al.
 * <p>
 * This is the primary API for JSE&nbsp;7 compliant TrueVFS applications:
 * Like the API of the module TrueVFS File*, this API is just a facade for the
 * module TrueVFS Kernel.
 * In contrast to the TrueVFS File* API however, this API can access any
 ...
 * {@link net.truevfs.path.TFileSystemProvider}.
 ...
 *     {@linkplain net.truevfs.path.TFileSystemProvider#TFileSystemProvider() instance} limits
 ...
 * {@link net.truevfs.path.TPath} instances instead by calling
 ...
 * <tr>
 *   <td>Feature</td>
 *   <td>{@link net.truevfs.path.TFileSystemProvider}</td>
