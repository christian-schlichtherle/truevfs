...
import net.truevfs.file.ConfiguredClientTestBase;
 ...
 * by using the API of the TrueVFS Path module.
 *
 * @param  <D> the type of the archive driver.
 * @see    TFileITSuite Test suite for the TrueVFS File* API.
...
extends ConfiguredClientTestBase<D> {
     ...
     * This value should identify the TrueVFS Path module in order to
