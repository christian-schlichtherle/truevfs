 ...
 * to the {@link #PrefixFilterFileSystemManager constructor}.
 *
 * @author Christian Schlichtherle
 * @version $Id$
 */
@ThreadSafe
public final class PrefixFilterFileSystemManager
extends FilterFileSystemManager<FileSystemManager> {
     ...
     */
    public PrefixFilterFileSystemManager(
