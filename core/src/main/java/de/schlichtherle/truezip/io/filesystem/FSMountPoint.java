...
import static de.schlichtherle.truezip.io.filesystem.FSPath.MOUNT_POINT_SEPARATOR;
...
public final class FSMountPoint implements Serializable, Comparable<FSMountPoint> {
     ...
     * {@link #FSMountPoint(String, boolean) new FSMountPoint(uri, normalize)}
     ...
     * This static factory method calls
     * {@link #FSMountPoint(URI, boolean) new FSMountPoint(uri, normalize)}
     * and wraps any thrown {@link URISyntaxException} in an
     * {@link IllegalArgumentException}.
     *
