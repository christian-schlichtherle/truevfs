 ...
 * @author christian
 */
public class SchemeBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    private static BeanDescriptor beanDescriptor = new BeanDescriptor  ( de.schlichtherle.truezip.io.filesystem.Scheme.class , null ); // NOI18N
    ...
    static {//GEN-HEADEREND:BeanDescriptor
        ...
        final PersistenceDelegate pd = new PersistenceDelegate() {
            ...
            protected Expression instantiate(Object oldInstance, Encoder out) {
                final Scheme scheme = (Scheme) oldInstance;
