 ...
 */
public class TextDataRaesZipTest extends RaesZipTestCase {

    private static final Logger logger
            = Logger.getLogger(TextDataRaesZipTest.class.getName());
    ...
    public static Test suite() throws Exception {
        TestSuite suite = new TestSuite(TextDataRaesZipTest.class);
        
        return suite;
    }
    
    /** Creates a new instance of RandomMessageZipTest */
    public TextDataRaesZipTest(String testName) {
        super(testName);
    }

    protected void setUp() throws Exception {
        super.data = TextDataRaesZipTest.data;
