...
public class PathsTest extends TestCase {
    ...
    public void testCutTrailingSeparators() {
        ...
        path = "";
        assertSame(path, Paths.cutTrailingSeparators(path, '/'));

        path = "dir";
        assertSame(path, Paths.cutTrailingSeparators(path, '/'));
        assertEquals("dir", Paths.cutTrailingSeparators("dir/", '/'));
        assertEquals("dir", Paths.cutTrailingSeparators("dir//", '/'));
        assertEquals("dir", Paths.cutTrailingSeparators("dir///", '/'));
        ...
        path = new String("/");
        assertSame(path, Paths.cutTrailingSeparators(path, '/'));
        assertEquals("/", Paths.cutTrailingSeparators("//", '/'));
        assertEquals("/", Paths.cutTrailingSeparators("///", '/'));
        assertEquals("/", Paths.cutTrailingSeparators("////", '/'));
    }
    ...
    /**
     * Test of split method, of class de.schlichtherle.io.util.Paths.
     */
