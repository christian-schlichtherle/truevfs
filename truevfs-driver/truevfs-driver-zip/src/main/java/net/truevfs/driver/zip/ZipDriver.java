...
import net.truevfs.driver.zip.core.AbstractZipDriver;
 ...
 */
@Immutable
public class ZipDriver extends AbstractZipDriver {
    ...
    @Override
    public AbstractZipDriverEntry newEntry(String name) {
        return new ZipDriverEntry(name);
    }

    @Override
    public AbstractZipDriverEntry newEntry(String name, ZipEntry template) {
