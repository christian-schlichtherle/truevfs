...
import static net.truevfs.driver.zip.core.io.DateTimeConverter.MAX_DOS_TIME;
import static net.truevfs.driver.zip.core.io.DateTimeConverter.MIN_DOS_TIME;
