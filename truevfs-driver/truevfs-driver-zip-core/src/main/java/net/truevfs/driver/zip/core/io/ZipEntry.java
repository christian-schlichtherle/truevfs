...
import static net.truevfs.driver.zip.core.io.Constants.FORCE_ZIP64_EXT;
import static net.truevfs.driver.zip.core.io.ExtraField.WINZIP_AES_ID;
import static net.truevfs.driver.zip.core.io.ExtraField.ZIP64_HEADER_ID;
import static net.truevfs.driver.zip.core.io.LittleEndian.readLong;
import static net.truevfs.driver.zip.core.io.LittleEndian.writeLong;
