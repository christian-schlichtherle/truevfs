...
import static net.truevfs.driver.zip.core.io.Constants.*;
import static net.truevfs.driver.zip.core.io.ExtraField.WINZIP_AES_ID;
import static net.truevfs.driver.zip.core.io.WinZipAesEntryExtraField.VV_AE_1;
import static net.truevfs.driver.zip.core.io.WinZipAesEntryExtraField.VV_AE_2;
