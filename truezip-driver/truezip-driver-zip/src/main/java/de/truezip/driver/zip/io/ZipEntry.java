...
import static de.truezip.driver.zip.io.ExtraField.ZIP64_HEADER_ID;
import static de.truezip.driver.zip.io.LittleEndian.readLong;
import static de.truezip.driver.zip.io.LittleEndian.writeLong;
 ...
 */
// TODO: Consider implementing de.truezip.kernel.entry.Entry.
@NotThreadSafe
public class ZipEntry implements Cloneable {
     ...
     *         ({@value de.truezip.driver.zip.io.ULong#MAX_VALUE}).
