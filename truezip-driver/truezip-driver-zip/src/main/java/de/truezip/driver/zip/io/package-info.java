 ...
 * <li>Support for
 *     {@link de.truezip.driver.zip.io.ZipOutputStream#ZipOutputStream(java.io.OutputStream,de.truezip.driver.zip.io.ZipFile) appending}
 *     to existing ZIP files.
 * <li>Support for
 *     {@link de.truezip.driver.zip.io.ZipFile#recoverLostEntries() recovering}
 *     lost entries when reading a ZIP file.
 * <li>Support for
 *     {@link de.truezip.driver.zip.io.ZipEntry#isEncrypted() reading}
 *     and
 *     {@link de.truezip.driver.zip.io.ZipEntry#setEncrypted(boolean) writing}
 ...
 *     {@link de.truezip.driver.zip.io.WinZipAesParameters}
 *     and inject it for reading and writing to the
 *     {@link de.truezip.driver.zip.io.ZipFile#setCryptoParameters(de.truezip.driver.zip.io.ZipCryptoParameters) ZipFile.setCryptoParameters(ZipCryptoParameters)}
 *     and
 *     {@link de.truezip.driver.zip.io.ZipOutputStream#setCryptoParameters(de.truezip.driver.zip.io.ZipCryptoParameters) ZipOutputStream.setCryptoParameters(ZipCryptoParameters)}
 *     classes.
 * <li>Support for
 *     {@link de.truezip.driver.zip.io.ZipEntry#getMethod() reading}
 *     and
 *     {@link de.truezip.driver.zip.io.ZipEntry#setMethod(int) writing}
 ...
 *     different locales!
 * <li>Support for
 *     {@link de.truezip.driver.zip.io.ZipEntry#getExternalAttributes() reading}
 *     and
 *     {@link de.truezip.driver.zip.io.ZipEntry#setExternalAttributes(long) writing}
