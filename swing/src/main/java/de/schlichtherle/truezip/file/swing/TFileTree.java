...
import de.schlichtherle.truezip.file.swing.tree.TFileTreeCellRenderer;
...
public final class TFileTree extends JTree {
     ...
     * root {@code root} file.
     */
    public TFileTree(File root) {
        this(new TFileTreeModel(root));
    }
    ...
    public void startEditingAtPath(TreePath path) {
        editedNode = (File) path.getLastPathComponent();
    ...
    protected void onEditingStopped(final ChangeEvent evt) {
        ...
        final File oldNode
                = (File) getLeadSelectionPath().getLastPathComponent();
        final File parent = oldNode.getParentFile();
        assert parent != null;
        ...
        final File node = new de.schlichtherle.truezip.file.TFile(parent, base);
    ...
    public String convertValueToText(
        ...
        final File node = (File) value;
        final File editedNode = getEditedNode();
    ...
    public void refresh() {
        ...
        final TreePath path = ftm.newTreePath((File) ftm.getRoot());
        if (path != null)
     ...
     *
     */
    public void refresh(final File node) {
        if (node == null)
    ...
    public void refresh(final TreePath paths[]) {
        ...
        for (int i = 0, l = paths.length; i < l; i++) {
            ...
            ftm.refresh((File) path.getLastPathComponent());
     ...
     */
    public boolean createNewFile(final File node) throws IOException {
        final TFileTreeModel ftm = getModel();
        final TreePath path = ftm.newTreePath(node);
        if (path == null)
            return false;
     ...
     * is selected and visible.
     */
    public boolean copyTo(final de.schlichtherle.truezip.file.TFile oldNode, final File node) {
        final TFileTreeModel ftm = getModel();
        final TreePath path = ftm.newTreePath(node);
        if (path == null)
            return false;
     ...
     * is selected and visible.
     */
    public boolean copyAllTo(final de.schlichtherle.truezip.file.TFile oldNode, final File node) {
        final TFileTreeModel ftm = getModel();
        final TreePath path = ftm.newTreePath(node);
        if (path == null)
            return false;
     ...
     * is selected and visible.
     */
    public boolean archiveCopyTo(final de.schlichtherle.truezip.file.TFile oldNode, final File node) {
        final TFileTreeModel ftm = getModel();
        final TreePath path = ftm.newTreePath(node);
        if (path == null)
            return false;
     ...
     * is selected and visible.
     */
    public boolean archiveCopyAllTo(final de.schlichtherle.truezip.file.TFile oldNode, final File node) {
        final TFileTreeModel ftm = getModel();
        final TreePath path = ftm.newTreePath(node);
        if (path == null)
            return false;
     ...
     * it if necessary.
     */
    public boolean renameTo(final File oldNode, final File node) {
        final TFileTreeModel ftm = getModel();
        final TreePath path = ftm.newTreePath(node);
        if (path == null)
            return false;
    ...
    private TreePath substPath(
            ...
            final TreePath path) {
        final File file = (File) tp.getLastPathComponent();
        if (file.equals(oldPath.getLastPathComponent())) {
            ...
            return parent.pathByAddingChild(
                    new de.schlichtherle.truezip.file.TFile((File) parent.getLastPathComponent(),
                             file.getName()));
        }
    }
    ...
    public void setSelectionNode(final File node) {
        final TFileTreeModel ftm = getModel();
        final TreePath path = ftm.newTreePath(node);
        if (path != null) {
            setSelectionPath(path);
    ...
    public void setSelectionNodes(final File[] nodes) {
        final TFileTreeModel ftm = getModel();
    ...
    public void scrollNodeToVisible(final File node) {
        final TFileTreeModel ftm = getModel();
        final TreePath path = ftm.newTreePath(node);
        if (path != null)
            scrollPathToVisible(path);
    ...
    implements TreeExpansionListener, CellEditorListener, Serializable {
        ...
        public void treeCollapsed(TreeExpansionEvent evt) {
            getModel().forget((File) evt.getPath().getLastPathComponent());
        }
