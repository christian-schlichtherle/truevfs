 ...
 * @version $Id$
 */
abstract class TDecoratingFileSystemView extends FileSystemView {
     ...
     */
    protected TDecoratingFileSystemView(final FileSystemView delegate) {
        if (delegate == null)
     ...
     * {@link FileSystemView#createFileSystemRoot(File)}
     * is called.
     */
    public File createFileSystemRootImpl(File f) {
        return (delegate instanceof TDecoratingFileSystemView)
                ? ((TDecoratingFileSystemView) delegate).createFileSystemRootImpl(f)
