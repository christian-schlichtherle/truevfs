...
public final class AuthenticationPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        final net.java.truevfs.key.swing.util.EnhancedPanel keyFilePanel = new net.java.truevfs.key.swing.util.EnhancedPanel();
        ...
        keyFilePanel.addPanelListener(new net.java.truevfs.key.swing.util.PanelListener() {
