...
import net.java.truevfs.key.macosx.keychain.Keychain.ItemClass;
...
import net.java.truevfs.key.macosx.keychain.Security.SecKeychainAttributeInfo;
import net.java.truevfs.key.macosx.keychain.Security.SecKeychainAttributeList;
