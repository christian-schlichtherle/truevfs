...
class WriteKeyPanel extends KeyPanel {
    ...
    private void initComponents() {
        ...
        passwdPanel = new de.schlichtherle.truezip.key.swing.EnhancedPanel();
        ...
        passwdPanel.addPanelListener(new de.schlichtherle.truezip.key.swing.PanelListener() {
            public void ancestorWindowShown(de.schlichtherle.truezip.key.swing.PanelEvent evt) {
                passwdPanelAncestorWindowShown(evt);
            }
            public void ancestorWindowHidden(de.schlichtherle.truezip.key.swing.PanelEvent evt) {
            }
        });
    ...
    private void passwdPanelAncestorWindowShown(de.schlichtherle.truezip.key.swing.PanelEvent evt) {//GEN-FIRST:event_passwdPanelAncestorWindowShown
    ...
    private de.schlichtherle.truezip.key.swing.EnhancedPanel passwdPanel;
