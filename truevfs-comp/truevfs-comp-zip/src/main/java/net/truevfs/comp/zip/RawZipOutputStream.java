...
import static net.truevfs.comp.zip.Constants.*;
import static net.truevfs.comp.zip.ExtraField.WINZIP_AES_ID;
import static net.truevfs.comp.zip.WinZipAesEntryExtraField.VV_AE_1;
import static net.truevfs.comp.zip.WinZipAesEntryExtraField.VV_AE_2;
import static net.truevfs.comp.zip.WinZipAesUtils.overhead;
import static net.truevfs.comp.zip.ZipEntry.*;
import static net.truevfs.comp.zip.ZipParametersUtils.parameters;
