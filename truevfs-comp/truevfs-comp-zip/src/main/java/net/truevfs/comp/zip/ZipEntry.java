...
import static net.truevfs.comp.zip.Constants.EMPTY;
import static net.truevfs.comp.zip.Constants.FORCE_ZIP64_EXT;
import static net.truevfs.comp.zip.ExtraField.WINZIP_AES_ID;
import static net.truevfs.comp.zip.ExtraField.ZIP64_HEADER_ID;
import static net.truevfs.comp.zip.LittleEndian.readLong;
import static net.truevfs.comp.zip.LittleEndian.writeLong;
